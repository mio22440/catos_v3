...
static_prio_private_data_t task1_private_data;
static_prio_task_config_t task1_config = 
{
    .prio = 0,
    .private_data = &task1_private_data
};

cat_task_t task2;
cat_stack_type_t task2_env[TASK2_STACK_SIZE];
static_prio_private_data_t task2_private_data;
static_prio_task_config_t task2_config = 
{
    .prio = 0,
    .private_data = &task2_private_data
};
